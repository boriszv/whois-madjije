const googleCom = {
  "WhoisRecord": {
    ...
    "footer": "\n",
    "audit": {
      "createdDate": "2021-09-25 01:01:38 UTC",
      "updatedDate": "2021-09-25 01:01:38 UTC"
    },
    ...
    "registryData": {
      ...
      "footer": "\n",
      "audit": {
        "createdDate": "2021-09-25 01:01:37 UTC",
        "updatedDate": "2021-09-25 01:01:37 UTC"
      },
      "customField1Name": "RegistrarContactEmail",
      "customField1Value": "abusecomplaints@markmonitor.com",
      "registrarName": "MarkMonitor Inc.",
    ...
    "domainNameExt": ".com",
    "estimatedDomainAge": 8776
  }
};

const googleMKD = {
    "WhoisRecord": {
        "domainName": "xn--c1aay4a.xn--d1alf",
        "parseCode": 8,
        "audit": {
            "createdDate": "2021-09-25 00:26:26 UTC",
            "updatedDate": "2021-09-25 00:26:26 UTC"
        },
        "registrarName": "UNET-REG",
        "registrarIANAID": "1105",
        "registryData": {
            "createdDate": "13.02.2015 16:31:59",
            "updatedDate": "07.12.2018 11:52:11",
            "expiresDate": "13.02.2022",
            "registrant": {
                "name": "admin-c:      UNET-C12",
                "rawText": "admin-c:      UNET-C12\nnsset:        UNET-NS2235"
            },
            "domainName": "xn--c1aay4a.xn--d1alf",
            "nameServers": {
                "rawText": "ns1.markmonitor.com\nns3.markmonitor.com\n",
                "hostNames": [
                    "ns1.markmonitor.com",
                    "ns3.markmonitor.com"
                ],
            ...
            "registrarName": "UNET-REG",
            "registrarIANAID": "1105",
            "createdDateNormalized": "0018-08-08 16:31:59 UTC",
            "updatedDateNormalized": "0013-06-09 11:52:11 UTC",
            "expiresDateNormalized": "0018-08-15 00:00:00 UTC",
            "whoisServer": "whois.marnet.mk"
        },
        "contactEmail": "ccops@markmonitor.com",
        "domainNameExt": ".xn--d1alf",
        "estimatedDomainAge": 731630
    }
};

const missingWhoisData = {
    "WhoisRecord": {
        "domainName": "negiewgeiwgniewngkljdgne.com",
        "parseCode": 0,
        "audit": {
            "createdDate": "2021-09-25 09:30:35 UTC",
            "updatedDate": "2021-09-25 09:30:35 UTC"
        },
        "dataError": "MISSING_WHOIS_DATA",
        "registryData": {
            "domainName": "negiewgeiwgniewngkljdgne.com",
            "rawText": "No match for domain \"NEGIEWGEIWGNIEWNGKLJDGNE.COM\".\n>>> Last update of whois database: 2021-09-24T08:05:51Z <<<\n\nNOTICE: The expiration date displayed in this record is the date the\nregistrar's sponsorship of the domain name registration in the registry is\ncurrently set to expire. This date does not necessarily reflect the expiration\ndate of the domain name registrant's agreement with the sponsoring\nregistrar.  Users may consult the sponsoring registrar's Whois database to\nview the registrar's reported date of expiration for this registration.\n\nTERMS OF USE: You are not authorized to access or query our Whois\ndatabase through the use of electronic processes that are high-volume and\nautomated except as reasonably necessary to register domain names or\nmodify existing registrations; the Data in VeriSign Global Registry\nServices' (\"VeriSign\") Whois database is provided by VeriSign for\ninformation purposes only, and to assist persons in obtaining information\nabout or related to a domain name registration record. VeriSign does not\nguarantee its accuracy. By submitting a Whois query, you agree to abide\nby the following terms of use: You agree that you may use this Data only\nfor lawful purposes and that under no circumstances will you use this Data\nto: (1) allow, enable, or otherwise support the transmission of mass\nunsolicited, commercial advertising or solicitations via e-mail, telephone,\nor facsimile; or (2) enable high volume, automated, electronic processes\nthat apply to VeriSign (or its computer systems). The compilation,\nrepackaging, dissemination or other use of this Data is expressly\nprohibited without the prior written consent of VeriSign. You agree not to\nuse electronic processes that are automated and high-volume to access or\nquery the Whois database except as reasonably necessary to register\ndomain names or modify existing registrations. VeriSign reserves the right\nto restrict your access to the Whois database in its sole discretion to ensure\noperational stability.  VeriSign may restrict or terminate your access to the\nWhois database for failure to abide by these terms of use. VeriSign\nreserves the right to modify these terms at any time.\n\nThe Registry database contains ONLY .COM, .NET, .EDU domains and\nRegistrars.",
            "parseCode": 64,
            "header": "No match for domain \"NEGIEWGEIWGNIEWNGKLJDGNE.COM\".\n>>> Last update of whois database: 2021-09-24T08:05:51Z <<<\nNOTICE: The expiration date displayed in this record is the date the\nregistrar's sponsorship of the domain name registration in the registry is\ncurrently set to expire. This date does not necessarily reflect the expiration\ndate of the domain name registrant's agreement with the sponsoring\nregistrar.  Users may consult the sponsoring registrar's Whois database to\nview the registrar's reported date of expiration for this registration.\nTERMS OF USE: You are not authorized to access or query our Whois\ndatabase through the use of electronic processes that are high-volume and\nautomated except as reasonably necessary to register domain names or\nmodify existing registrations; the Data in VeriSign Global Registry\nServices' (\"VeriSign\") Whois database is provided by VeriSign for\ninformation purposes only, and to assist persons in obtaining information\nabout or related to a domain name registration record. VeriSign does not\nguarantee its accuracy. By submitting a Whois query, you agree to abide\nby the following terms of use: You agree that you may use this Data only\nfor lawful purposes and that under no circumstances will you use this Data\nto: (1) allow, enable, or otherwise support the transmission of mass\nunsolicited, commercial advertising or solicitations via e-mail, telephone,\nor facsimile; or (2) enable high volume, automated, electronic processes\nthat apply to VeriSign (or its computer systems). The compilation,\nrepackaging, dissemination or other use of this Data is expressly\nprohibited without the prior written consent of VeriSign. You agree not to\nuse electronic processes that are automated and high-volume to access or\nquery the Whois database except as reasonably necessary to register\ndomain names or modify existing registrations. VeriSign reserves the right\nto restrict your access to the Whois database in its sole discretion to ensure\noperational stability.  VeriSign may restrict or terminate your access to the\nWhois database for failure to abide by these terms of use. VeriSign\nreserves the right to modify these terms at any time.\nThe Registry database contains ONLY .COM, .NET, .EDU domains and\nRegistrars.",
            "strippedText": "",
            "footer": "",
            "audit": {
                "createdDate": "2021-09-25 09:30:35 UTC",
